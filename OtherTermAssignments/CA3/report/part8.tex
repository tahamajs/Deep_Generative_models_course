...
\begin{itemize}[leftmargin=*]
  ...
  because clean/noisy/denoised triplets are available in one archive; NCSN
  quantitative diagnostics focus on transformation and texture statistics
  unless matched clean references are present.
\end{itemize}
