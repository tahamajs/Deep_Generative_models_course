...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{figures/bayesian_network.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{figures/complex_network.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{figures/beta_comparison.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{figures/dsprites_samples.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{figures/training_loss.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{figures/reconstructions.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{figures/latent_space_pca.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{figures/latent_traversal.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{figures/interpolation.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{figures/loss_components.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{figures/learning_curves.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{figures/failure_cases.png}
